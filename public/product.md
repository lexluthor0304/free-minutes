...
Free Minutes helps users turn web meeting audio, shared tab audio, demos, interviews, and review sessions into editable transcript text. The app focuses on a simple listening screen, compact transcript editing, source labels, and practical TXT, Markdown, WebM audio, PNG screenshot, and ZIP export.
